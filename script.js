...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
  let countDown = new Date('April 24, 2024 11:35:00').getTime();
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Saya Ruq ruq pada hari ini rabu, 24 April 2024 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 20</b>", " ", "Kepada Pia, semoga kamu panjang umur, sehat selalu. dan jadi diri kamu sendiri. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- Abdurrahman Alfaruqi :)"],
  startDelay: 4000,
  speed: 75,
